...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, TraceWriter log, Microsoft.Azure.WebJobs.ExecutionContext context)
{
    ...
    try
    {
        ...
        if (lang == null)
        {
            ...
            {
                string vv = System.Environment.GetEnvironmentVariable("HTML2PDF_DEFAULT_lang");
                if (vv != null)
                {
                    lang = vv;
        ...
        ParamInfo html_transf = handleParameter(json, config_json, "html", true, rootloc, DEFAULT_html_CODE, null, log);
