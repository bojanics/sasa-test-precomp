...
module.exports = function (context, req) {
    context.log('JavaScript HTTP trigger function for HRLeasing calculation processed a request.');

    var calcres = null;
    var err = null;
    try {
        calcres = JSON.parse(calc.calculate(req.body));
    } catch (e) {
        err = e;
    }
