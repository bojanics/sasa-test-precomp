...
<fo:block/>
<fo:block-container display-align="before" reference-orientation="0">
<fo:block position="relative" text-align="center" color="rgb-icc(0,0,0, #CMYK, 0.65,0.53,0.51,1.0)" font-family="Calibri" font-size="11.0pt" line-height="14.5pt" white-space-collapse="false"  linefeed-treatment="preserve" white-space-treatment="ignore-if-surrounding-linefeed"  hyphenate="true" language="en"  padding-bottom="0.0pt" start-indent="0.0pt" end-indent="0.0pt" padding-top="0.0pt" padding="0.0pt" width="328.0pt"  height="45.0pt" ><xsl:call-template name="rechnung_srs" /></fo:block>
</fo:block-container>
<fo:block-container display-align="before" reference-orientation="0">
				...
				<fo:table-row  height="10pt" >					
					<fo:table-cell   number-columns-spanned="2">
						<fo:block font-size="12pt" text-align="left" font-style="bold">
							<xsl:value-of select="'Prämienrechnung zur Strafrechtsschutzversicherung Nr.: '"/>
...
<!-- Leerzeile -->
				...
				<fo:table-row  height="12pt">				
					<fo:table-cell text-align="left" number-columns-spanned="2">
						<fo:block>
							<xsl:value-of select="concat('vom ',NS1:item[@NS1:name='begin_date_srs']/@NS1:value, ' bis ',NS1:item[@NS1:name='end_date_srs']/@NS1:value)" />
						</fo:block>
					</fo:table-cell>
				</fo:table-row>	
...
<!-- Leerzeile -->
				...
				<fo:table-row  height="12pt">
					...
					<fo:table-cell text-align="right">
						<fo:block>
							<xsl:value-of select="translate(format-number(number(NS1:item[@NS1:name='premium_srs']/@NS1:value),'#,##0.00'),'.,',',.')" />
						</fo:block>
					</fo:table-cell>					
				</fo:table-row>	
				...
				<fo:table-row  height="12pt">
					...
					<fo:table-cell text-align="right">
						<fo:block>
							<xsl:value-of select="translate(format-number(number(NS1:item[@NS1:name='premium_srs']/@NS1:value*0.11),'#,##0.00'),'.,',',.')" />
						</fo:block>
					</fo:table-cell>					
				</fo:table-row>	
				...
				<fo:table-row  height="12pt">
					...
					<fo:table-cell text-align="right">
						<fo:block font-style="bold">
							<xsl:value-of select="translate(format-number(number(NS1:item[@NS1:name='premium_srs']/@NS1:value*1.11),'#,##0.00'),'.,',',.')" />
						</fo:block>
					</fo:table-cell>					
				</fo:table-row>	
...
<!-- GENERATED TEMPLATE rechnung_srs -->
<xsl:template name="rechnung_srs" >
<fo:block-container display-align="before" reference-orientation="0">
