...
<fo:table-column column-number="3" column-width="33.33%" />
   <fo:table-body>                                              
      <fo:table-row>                                           
         ...
         <fo:table-cell> 
            <fo:block>
	    	<fo:external-graphic src="url({concat($common_img,'signature_1.png')})" content-width="5cm" />
	    </fo:block>
         </fo:table-cell>
         <fo:table-cell> 
            <fo:block>
	    	<fo:external-graphic src="url({concat($common_img,'signature_2.png')})" content-width="5cm" />
	    </fo:block>
         </fo:table-cell>                         
      </fo:table-row>
